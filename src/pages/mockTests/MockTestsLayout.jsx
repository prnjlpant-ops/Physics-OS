  ...
  return (
    <div className="flex flex-col gap-5 px-4 py-5 sm:px-6 lg:px-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-lg font-semibold text-[#e8e8e8]">Mock Tests</h2>
          <p className="text-xs text-[#858585]">
            The central examination environment for IIT JAM, JEST, GATE and TIFR.
          </p>
        </div>
      </div>
